        ...
        <>
            ...
            <div className="menu-projetos--corpo">
                ...
                <section className="menu-projetos">
                    ...
                    ></CardProjeto>
                    <CardProjeto titulo="Projeto de Acolhimento de Ingressantes"
                        descricao="Projeto de ensino para elaboração de tutorial de acolhimento dos ingressantes em cursos de Computação, voltado à organização da graduação e da carreira profissional."
                        expandido="Um dois objetivos do PET é contribuir com os demais alunos da Instituição, principalmente os ingressantes. Esse projeto de ensino visa acolher e orientar os novos alunos da Computação sobre como organizar a graduação utilizando a ferramenta Notion, além de dar uma introdução à construção de portfólio no GitHub e um currículo no LinkedIn."
                    ></CardProjeto>
                </section>
            </div>
        </>
