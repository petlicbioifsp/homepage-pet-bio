...
export const AboutPET:IConstText = {
    ...
    Treinamento, cujo objetivo era criar um grupo de elite intelectual, dedicado à pesquisa 
    ...
    Aqui, no nosso site do PET vinculado ao curso de Licenciatura em Ciências Biológicas do IFSP,
    você encontrará informações valiosas sobre essa iniciativa enriquecedora que engloba ensino, 
    pesquisa, extensão e desenvolvimento de habilidades profissionais, 
    moldando o futuro de estudantes apaixonados pela Biologia. `,
...
export const Purpose:IConstText = {
    ...
    voluntários. Cada estudante do PET possui uma dedicação semanal de 20h, os participantes têm a oportunidade de se 
    envolver em projetos inovadores que não só fortalecem sua base teórica, mas também os capacitam a aplicar seus 
    conhecimentos em situações práticas, colaborando com a comunidade. o PETLICBIO proporciona um ambiente propício para 
    o desenvolvimento de habilidades profissionais essenciais, como liderança, comunicação eficaz, trabalho em equipe e pensamento crítico.
    Os participantes são incentivados a assumir papéis de liderança em projetos de pesquisa e extensão, preparando-os para enfrentar desafios
    do mundo acadêmico e do mercado de trabalho. Atualmente, o grupo conta com a orientação dedicada da Professora Caroline Arantes Magalhães. 
    Venha fazer parte desta comunidade comprometida com a excelência acadêmica e o desenvolvimento profissional.
    `,
    ...
    simultaneamente em diferentes atividades, simultaneamente em diferentes atividades, que engloba ensino, pesquisa, extensão os participantes têm a oportunidade de se 
    envolver em projetos inovadores que não só fortalecem sua base teórica, mas também os capacitam a aplicar seus 
    conhecimentos em situações práticas, colaborando com a comunidade. Atualmente, o grupo é coordenado pela dedicada Professora Caroline Arantes Magalhães`
}