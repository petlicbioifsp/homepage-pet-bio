...
export default function CardProjeto(props){
    ...
    return(
        <motion.div className={isOpen ? "card aberto" : "card"} onClick={()=> setIsOpen(!isOpen)}>
            ...
            {isOpen && (
                <motion.div>
                    <p className='card--texto__espancao'>AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</p>
                    <div className='card--texto__envolvidos'>
                        <p className='card--texto__espancao'>Envolvidos: </p>
                        <p className='card--texto__espancao'>{props.envolvidos}</p>
                    </div>
                </motion.div>
            )}
        </motion.div>
