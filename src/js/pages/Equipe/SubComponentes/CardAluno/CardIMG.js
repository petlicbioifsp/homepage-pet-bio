...
function CardImage(_a) {
    ...
    return (react_1.default.createElement("div", { className: CardAluno_module_css_1.default.imgContainer, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
