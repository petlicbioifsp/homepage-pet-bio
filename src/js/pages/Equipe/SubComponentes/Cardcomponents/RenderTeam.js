...
var renderMembers = function (arrMembers, customClassCard, customCardSize) {
    var renderMembers = function (arrMember) { return (react_1.default.createElement("div", { className: Cards_module_css_1.default[customClassCard] },
        react_1.default.createElement(Card_1.default, { customClass: customCardSize, key: arrMember.id, nome: arrMember.nome, foto: arrMember.foto, tipo: arrMember.tipo, ano: arrMember.ano, github: arrMember.github, linkedin: arrMember.linkedin }))); };
