...
function Card(_a) {
    var customClass = _a.customClass, nome = _a.nome, foto = _a.foto, tipo = _a.tipo, github = _a.github, linkedin = _a.linkedin, ano = _a.ano;
    var altFoto = "Foto de ".concat(nome, ", integrante do PET ADS do IFSP Sao Carlos");
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(CardIMG_1.default, { customClass: customClass, foto: foto, altFoto: altFoto, github: github, linkedin: linkedin, nome: '', tipo: '', ano: '' }),
