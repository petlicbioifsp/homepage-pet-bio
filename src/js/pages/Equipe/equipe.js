        ...
        react_1.default.createElement("div", { className: "equipe--corpo" },
            react_1.default.createElement(useFetchEquipe_1.default, { render: function (_a) {
                    ...
                    return (react_1.default.createElement(react_1.default.Fragment, null,
                        ...
                        react_1.default.createElement(Render_1.default, { data: tutores, customClass: "equipe--tutor", render: function (tutor, index) { return (react_1.default.createElement(CardIntegrantes_1.default, { key: tutor.id, github: tutor.github, nome: tutor.nome, tipo: tutor.tipo, srcFoto: tutor.srcFoto, ano: tutor.ano, linkedin: tutor.linkedin, altFoto: "" })); } }),
                        react_1.default.createElement(Render_1.default, { data: alunos, customClass: "equipe--alunos", render: function (aluno, index) { return (react_1.default.createElement(CardIntegrantes_1.default, { key: aluno.id, nome: aluno.nome, srcFoto: aluno.srcFoto, tipo: aluno.tipo, ano: aluno.ano, github: aluno.github, linkedin: aluno.linkedin, altFoto: "" })); } }),
                        react_1.default.createElement(react_collapsible_1.default, { classParentString: "EquipeCollapsible", trigger: react_1.default.createElement(useCollapsibleTrigger_1.default, { text: "Ex-Integrantes", page: "Equipe" }), triggerWhenOpen: react_1.default.createElement(useCollapsibleOpen_1.default, { text: "Ex-Integrantes", page: "Equipe" }) },
                            react_1.default.createElement(Render_1.default, { data: exTutores, customClass: "equipe--tutor", render: function (exTutor, index) { return (react_1.default.createElement(CardExMembros_1.default, { key: exTutor.id, nome: exTutor.nome, tipo: exTutor.tipo, srcFoto: exTutor.srcFoto, ano: exTutor.ano, linkedin: exTutor.linkedin })); } }),
                            react_1.default.createElement(Render_1.default, { data: exAlunos, customClass: "equipe--alunos", render: function (exAluno, index) { return (react_1.default.createElement(CardExMembros_1.default, { key: exAluno.id, nome: exAluno.nome, srcFoto: exAluno.srcFoto, linkedin: exAluno.linkedin, altFoto: "" })); } }))));
                } }))));
}
