        ...
        react_1.default.createElement("div", { className: Equipe_module_css_1.default["equipe--corpo"] },
            react_1.default.createElement(useFetchEquipe_1.default, { render: function (_a) {
                    ...
                    return (react_1.default.createElement(react_1.default.Fragment, null,
                        ...
                        react_1.default.createElement(EquipeSection_1.default, { data: tutores, customClass: "equipe--tutor", cardClass: "card", imgContainerClass: "imgContainer" }),
                        react_1.default.createElement(EquipeSection_1.default, { data: alunos, customClass: "equipe--alunos", cardClass: "card", imgContainerClass: "imgContainer" }),
                        react_1.default.createElement(react_collapsible_1.default, { classParentString: Equipe_module_css_1.default["EquipeCollapsible"], trigger: react_1.default.createElement(useCollapsibleTrigger_1.default, { text: "Ex-Integrantes", page: "Equipe" }), triggerWhenOpen: react_1.default.createElement(useCollapsibleOpen_1.default, { text: "Ex-Integrantes", page: "Equipe" }) },
                            react_1.default.createElement(EquipeSection_1.default, { data: exTutores, customClass: "equipe--tutor", cardClass: "cardExMembro", imgContainerClass: "ExImgContainter" }),
                            react_1.default.createElement(EquipeSection_1.default, { data: exAlunos, customClass: "equipe--alunos", cardClass: "cardExMembro", imgContainerClass: "ExImgContainter" }))));
                } }))));
}
