...
var PurposePET_1 = require("./TextConstants/PurposePET");
var AboutPETtext_1 = require("./TextConstants/AboutPETtext");
var Infos_js_1 = __importDefault(require("./SubComponentes/Home_Infos/Infos.js"));
...
function Home() {
    ...
    var _b = (0, useScrollToSection_1.default)(), showArrow2 = _b.showArrow, sectionRef2 = _b.sectionRef, scrollToSection2 = _b.scrollToSection;
    return (react_1.default.createElement("div", { className: "home" },
        ...
        react_1.default.createElement("div", { className: 'scrolltoView', id: 'section1', ref: sectionRefAbout },
            react_1.default.createElement(Reveal_1.default, null,
                react_1.default.createElement(Infos_js_1.default, { title: "Sobre o PET", content: isMobile ? AboutPETtext_1.AboutPET.mobile : AboutPETtext_1.AboutPET.desktop }),
                react_1.default.createElement(Button_1.default, { value: "Processo Seletivo", to: '/processo-seletivo' }))),
        react_1.default.createElement(ScrollArrow_1.default, { showArrow: showArrow2, scrollToSection: scrollToSection2, customClass1: 'scroll-arrow2', customClass2: 'home-arrow' }),
        react_1.default.createElement("div", { className: 'scrolltoView', id: 'section2', ref: sectionRef2 },
            react_1.default.createElement(Reveal_1.default, null,
                react_1.default.createElement(Infos_js_1.default, { title: "Prop\u00F3sito", content: isMobile ? PurposePET_1.Purpose.mobile : PurposePET_1.Purpose.desktop }),
