...
function Requisitos(_a) {
    var title = _a.title, introducao = _a.introducao, item_1 = _a.item_1, item_2 = _a.item_2;
    return (react_1.default.createElement("div", { className: Requisitos_module_css_1.default.requisitos },
        ...
        react_1.default.createElement("p", { className: Requisitos_module_css_1.default.texto }, introducao),
